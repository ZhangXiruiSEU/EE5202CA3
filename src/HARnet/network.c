...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x09f79946067b547b76872f9fbe1e7f3c"
#define _STAI_NETWORK_DATETIME            "2026-03-27T11:39:39+0000"
...
static const stai_network_info g_network_info = {
  ...
  .inputs = (stai_tensor[STAI_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 3, 1, 26, 3),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  .activations = (stai_tensor[STAI_NETWORK_ACTIVATIONS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 2432),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 48300),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
static const ai_u32 conv1d_conv2d_t_in_0_shape_ch_const_u32 = 3;
static const ai_u32 conv1d_conv2d_t_out_0_shape_ch_const_u32 = 16;
static const ai_u32 conv1d_conv2d_t_in_0_shape_w_const_u32 = 1;
static const ai_u32 conv1d_conv2d_t_in_0_shape_h_const_u32 = 26;
static const ai_u32 conv1d_conv2d_t_out_0_shape_w_const_u32 = 1;
static const ai_u32 conv1d_conv2d_t_out_0_shape_h_const_u32 = 24;
static const ai_u32 conv1d_conv2d_t_weight_0_shape_w_const_u32 = 1;
static const ai_u32 conv1d_conv2d_t_weight_0_shape_h_const_u32 = 3;
static const ai_i32 conv1d_conv2d_l_pad_W_0_const_s32 = 0;
static const ai_i32 conv1d_conv2d_l_pad_H_0_const_s32 = 0;
...
static const ai_i32 conv1d_t_in_0_shape_ch_h_prod_const_s32 = 384;

static const ai_u32 conv1d_1_conv2d_t_in_0_shape_ch_const_u32 = 16;
static const ai_u32 conv1d_1_conv2d_t_out_0_shape_ch_const_u32 = 8;
static const ai_u32 conv1d_1_conv2d_t_in_0_shape_w_const_u32 = 1;
static const ai_u32 conv1d_1_conv2d_t_in_0_shape_h_const_u32 = 24;
static const ai_u32 conv1d_1_conv2d_t_out_0_shape_w_const_u32 = 1;
static const ai_u32 conv1d_1_conv2d_t_out_0_shape_h_const_u32 = 22;
static const ai_u32 conv1d_1_conv2d_t_weight_0_shape_w_const_u32 = 1;
static const ai_u32 conv1d_1_conv2d_t_weight_0_shape_h_const_u32 = 3;
static const ai_i32 conv1d_1_conv2d_l_pad_W_0_const_s32 = 0;
static const ai_i32 conv1d_1_conv2d_l_pad_H_0_const_s32 = 0;
...
static const ai_i32 conv1d_1_t_in_0_shape_ch_h_prod_const_s32 = 176;


static const ai_i32 dense_t_in_0_shape_ch_prod_const_s32 = 64;


static const ai_i32 dense_1_t_in_0_shape_ch_prod_const_s32 = 3;
STAI_API_ENTRY
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN conv1d_conv2d */
  {
    ...
    ai_float* conv1d_conv2d_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 896);
    const ai_u8* conv1d_conv2d_t_weight_0_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 0);
    const ai_u8* conv1d_conv2d_t_weight_1_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 576);
    ai_float* conv1d_conv2d_t_scratch_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 860);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(0, 1, {(stai_ptr) conv1d_conv2d_t_in_0_ptr_const_f32});
    
  forward_lite_conv2d_if32of32wf32(conv1d_conv2d_t_in_0_ptr_const_f32, conv1d_conv2d_t_out_0_ptr_f32, conv1d_conv2d_t_weight_0_ptr_const_u8, conv1d_conv2d_t_weight_1_ptr_const_u8, conv1d_conv2d_t_scratch_0_ptr_f32, conv1d_conv2d_t_in_0_shape_ch_const_u32, conv1d_conv2d_t_out_0_shape_ch_const_u32, conv1d_conv2d_t_in_0_shape_w_const_u32, conv1d_conv2d_t_in_0_shape_h_const_u32, conv1d_conv2d_t_out_0_shape_w_const_u32, conv1d_conv2d_t_out_0_shape_h_const_u32, conv1d_conv2d_t_weight_0_shape_w_const_u32, conv1d_conv2d_t_weight_0_shape_h_const_u32, conv1d_conv2d_l_pad_W_0_const_s32, conv1d_conv2d_l_pad_H_0_const_s32, conv1d_conv2d_l_stride_1_const_u16, conv1d_conv2d_l_stride_0_const_u16, 3, 1, conv1d_conv2d_l_dilation_H_const_u16, conv1d_conv2d_l_dilation_W_const_u16, (ai_size)(1));
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(0, 1, {(stai_ptr) conv1d_conv2d_t_out_0_ptr_f32});
  }
  /* LITE_KERNEL_SECTION END conv1d_conv2d */
  /* LITE_KERNEL_SECTION BEGIN conv1d */
  {
      ai_handle conv1d_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 896);
    const ai_handle conv1d_t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 896);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(0, 1, {(stai_ptr) conv1d_t_in_0_ptr_const_handle});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(0, 1, {(stai_ptr) conv1d_t_out_0_ptr_handle});
  }
  /* LITE_KERNEL_SECTION END conv1d */
  /* LITE_KERNEL_SECTION BEGIN conv1d_1_conv2d */
  {
      const ai_float* conv1d_1_conv2d_t_in_0_ptr_const_f32 = (ai_float*)(net_ctx->_activations[0] + 896);
    ai_float* conv1d_1_conv2d_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 0);
    const ai_u8* conv1d_1_conv2d_t_weight_0_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 640);
    const ai_u8* conv1d_1_conv2d_t_weight_1_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 2176);
    ai_float* conv1d_1_conv2d_t_scratch_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 704);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(1, 1, {(stai_ptr) conv1d_1_conv2d_t_in_0_ptr_const_f32});
    
  forward_lite_conv2d_if32of32wf32(conv1d_1_conv2d_t_in_0_ptr_const_f32, conv1d_1_conv2d_t_out_0_ptr_f32, conv1d_1_conv2d_t_weight_0_ptr_const_u8, conv1d_1_conv2d_t_weight_1_ptr_const_u8, conv1d_1_conv2d_t_scratch_0_ptr_f32, conv1d_1_conv2d_t_in_0_shape_ch_const_u32, conv1d_1_conv2d_t_out_0_shape_ch_const_u32, conv1d_1_conv2d_t_in_0_shape_w_const_u32, conv1d_1_conv2d_t_in_0_shape_h_const_u32, conv1d_1_conv2d_t_out_0_shape_w_const_u32, conv1d_1_conv2d_t_out_0_shape_h_const_u32, conv1d_1_conv2d_t_weight_0_shape_w_const_u32, conv1d_1_conv2d_t_weight_0_shape_h_const_u32, conv1d_1_conv2d_l_pad_W_0_const_s32, conv1d_1_conv2d_l_pad_H_0_const_s32, conv1d_1_conv2d_l_stride_1_const_u16, conv1d_1_conv2d_l_stride_0_const_u16, 3, 1, conv1d_1_conv2d_l_dilation_H_const_u16, conv1d_1_conv2d_l_dilation_W_const_u16, (ai_size)(1));
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(1, 1, {(stai_ptr) conv1d_1_conv2d_t_out_0_ptr_f32});
  }
  /* LITE_KERNEL_SECTION END conv1d_1_conv2d */
  /* LITE_KERNEL_SECTION BEGIN conv1d_1 */
  {
      ai_handle conv1d_1_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 704);
    const ai_handle conv1d_1_t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 0);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(1, 1, {(stai_ptr) conv1d_1_t_in_0_ptr_const_handle});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(1, 1, {(stai_ptr) conv1d_1_t_out_0_ptr_handle});
  }
  ...
  /* LITE_KERNEL_SECTION BEGIN dense_dense */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 704),
      .weights = (float*)(net_ctx->_weights[0] + 2208),
      .bias = (float*)(net_ctx->_weights[0] + 47264),
      .n_channel_in = 176,
      .n_channel_out = 64,
      .n_elements = 1,
    };
  
  _STAI_NETWORK_EVENT_NODE_START_CB(4, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 704)});
    
  forward_lite_dense_if32of32wf32((forward_lite_dense_if32of32wf32_args*)&arg_30f51e);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(4, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 0)});
  }
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(4, 1, {(stai_ptr) dense_t_in_0_ptr_const_handle});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(4, 1, {(stai_ptr) dense_t_out_0_ptr_handle});
  }
  ...
  /* LITE_KERNEL_SECTION BEGIN dense_1_dense */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 47520),
      .bias = (float*)(net_ctx->_weights[0] + 48288),
      .n_channel_in = 64,
      .n_channel_out = 3,
      .n_elements = 1,
    };
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(5, 1, {(stai_ptr) dense_1_t_in_0_ptr_const_handle});
    
  forward_lite_nl_softmax_if32of32(dense_1_t_out_0_ptr_handle, dense_1_t_in_0_ptr_const_handle, dense_1_t_in_0_shape_ch_prod_const_s32, 1, 3);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(5, 1, {(stai_ptr) dense_1_t_out_0_ptr_handle});
  }
...
const uintptr_t _activations_alignment[] = STAI_NETWORK_ACTIVATIONS_ALIGNMENTS;
  ...
  net_ctx->_inputs[0] = activations[0] + 548;
